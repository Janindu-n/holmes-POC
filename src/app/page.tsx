...
export default function Home() {
  ...
  useEffect(() => {
    ...
    // Direct DOM manipulation for parallax effect to avoid React re-renders on scroll
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
            ...
            <div className="relative lg:h-auto h-[400px] w-full rounded-2xl overflow-hidden shadow-2xl">
              ...
              <img
                alt="Living room with smart security camera feed"
            ...
            <div className="order-2 lg:order-1">
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-4">
                  <img
                    alt="Manifold of property management tasks"
                    className="w-full aspect-[3/4] rounded-2xl object-cover shadow-lg"
                  ...
                  />
                  <img
                    alt="Property maintenance tools"
                ...
                <div className="space-y-4 pt-12">
                  <img
                    alt="Digital home profile on tablet"
                    className="w-full aspect-square rounded-2xl object-cover shadow-lg"
                  ...
                  />
                  <img
                    alt="Inspecting property exterior"
                    className="w-full aspect-[3/4] rounded-2xl object-cover shadow-lg"
