...
export default function Home() {
  ...
  // Optimization: Use direct DOM manipulation for high-frequency scroll updates
  // to bypass React's state reconciliation and prevent unnecessary re-renders.
  useEffect(() => {
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
            ...
            <div className="relative lg:h-auto h-[400px] w-full rounded-2xl overflow-hidden shadow-2xl">
              ...
              {/* Optimization: Use <img> with loading="lazy" instead of CSS background-image
                  for native browser lazy loading and improved LCP performance. */}
              <img
                alt="Living Room Cam"
