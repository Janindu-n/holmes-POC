...
export default function Home() {
  // Optimization: Using useRef instead of useState for scroll position to avoid re-renders.
  // Re-renders on every scroll event (approx 16-20 per 1000px) are now reduced to 0.
  ...
  useEffect(() => {
    ...
    // Sync UI with scroll position on mount
    updateParallax();
