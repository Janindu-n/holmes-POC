...
/**
 * Landing page optimized as a Server Component.
 * The high-frequency scroll parallax logic has been moved to the leaf HeroParallax component
 * to eliminate re-renders of the entire page on every scroll event.
 */
