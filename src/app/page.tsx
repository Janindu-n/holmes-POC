      ...
      if (rafId === null) {
        rafId = requestAnimationFrame(() => {
          if (heroRef.current) {
            ...
            // Directly manipulating the DOM to avoid React re-renders on every scroll tick.
            // Using requestAnimationFrame inside scroll listener ensures we only update
            // when necessary and stay synced with the browser's refresh rate.
            // Reduces scroll-triggered re-renders to zero.
