...
/**
 * Home component refactored to a Server Component.
 * High-frequency interactivity (parallax) is moved to the leaf Client Component <HeroParallax />.
 * This reduces client-side JS and prevents full-page re-renders on scroll.
 */
      ...
      <section className="relative overflow-hidden bg-background-light dark:bg-background-dark pt-16 pb-20 lg:pt-24 lg:pb-28">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
            {/* Optimized leaf Client Component handles high-frequency parallax style updates */}
            <HeroParallax />
