...
export default function Home() {
  ...
  useEffect(() => {
    // Bolt Optimization: Using direct DOM manipulation with requestAnimationFrame
    // to bypass React's render cycle for high-frequency scroll animations.
    // This reduces re-renders from ~60fps to 0 during scroll.
    let ticking = false;
