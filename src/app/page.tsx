...
export default function Home() {
  ...
  // PERFORMANCE: Use direct DOM manipulation and requestAnimationFrame for 60fps parallax
  // This avoids React state updates (re-renders) on every scroll pixel.
  useEffect(() => {
    ...
    // Initial sync to set position on mount or refresh
    updateParallax();
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
            ...
            <div className="relative lg:h-auto h-[400px] w-full rounded-2xl overflow-hidden shadow-2xl">
              ...
              {/* PERFORMANCE: Replaced div background with img tag for better resource management.
                  Hero image is prioritized (no loading="lazy") to optimize LCP. */}
              <img
                alt="Live Room Feed"
