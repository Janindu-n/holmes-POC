...
export default function Home() {
  // Optimization: Using a ref for the hero container to update styles directly in the DOM.
  // This avoids re-rendering the entire Home component tree on every scroll event,
