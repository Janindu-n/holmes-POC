...
/**
 * Isolated hero content component to encapsulate scroll-based parallax logic.
 * This prevents the entire Home page from re-rendering on every scroll event,
 * significantly improving performance and reducing CPU overhead.
 */
