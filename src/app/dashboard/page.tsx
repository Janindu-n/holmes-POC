...
export default function Dashboard() {
  ...
  useEffect(() => {
    // Defense in depth: if auth is not initialized (e.g. build time),
    // we redirect to login as a safe default.
    if (!auth) {
  ...
  if (authLoading) {
    return (
      <div className="min-h-screen bg-dashboard-bg dark:bg-background-dark flex flex-col items-center justify-center p-4">
        <div className="flex flex-col items-center gap-4">
          <div className="flex size-12 items-center justify-center rounded-xl bg-primary text-white shadow-lg animate-pulse">
