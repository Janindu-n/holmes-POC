...
export default function Dashboard() {
  ...
  useEffect(() => {
    // Defense in depth: handle null auth instance
    if (!auth) {
  ...
  const handleLogout = async () => {
    try {
      ...
      // Security enhancement: Generic error message to avoid leaking stack traces
  ...
  if (authLoading) {
    return (
      <div className="min-h-screen bg-dashboard-bg dark:bg-background-dark flex flex-col items-center justify-center p-4 text-center">
        <div className="flex flex-col items-center gap-4">
          <div className="relative flex h-16 w-16">
            ...
            <div className="relative inline-flex rounded-full h-16 w-16 bg-primary items-center justify-center">
              <span className="material-symbols-outlined text-3xl text-white animate-spin">security</span>
            </div>
          </div>
          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex flex-col items-end">
                ...
                {error && <span className="absolute top-16 right-4 text-[10px] text-red-500 bg-white dark:bg-surface-dark px-2 py-1 rounded shadow-sm border border-red-100 animate-fade-in">{error}</span>}
              </div>
