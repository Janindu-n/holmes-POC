...
export default function Dashboard() {
  ...
  useEffect(() => {
    // Sentinel: Implement authentication guard to protect dashboard content
    if (!auth) {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-dashboard-bg dark:bg-background-dark">
        <div className="flex flex-col items-center gap-4">
          <div className="flex items-center justify-center size-12 bg-primary rounded-xl text-white shadow-lg animate-pulse">
            <span className="material-symbols-outlined text-3xl">shield_person</span>
          </div>
          <p className="text-stone-600 dark:text-stone-300 font-medium animate-pulse">Verifying access...</p>
        </div>
      </div>
    );
  }
