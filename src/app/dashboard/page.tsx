...
export default function Dashboard() {
  ...
  useEffect(() => {
    // If auth is not initialized (e.g. missing API key), we redirect to login to fail securely
    if (!auth) {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-dashboard-bg dark:bg-background-dark">
        <div className="text-center">
          <div className="flex size-12 items-center justify-center rounded-xl bg-primary text-white shadow-lg mx-auto mb-4 animate-bounce">
