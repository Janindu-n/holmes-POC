    ...
    return (
      <div className="min-h-screen bg-dashboard-bg dark:bg-background-dark flex items-center justify-center">
        <div className="flex flex-col items-center gap-4">
          <span className="material-symbols-outlined text-stone-400 text-6xl animate-spin">
            progress_activity
          </span>
  ...
  if (error) {
    return (
      <div className="min-h-screen bg-dashboard-bg dark:bg-background-dark flex items-center justify-center p-4">
        <div className="bg-white dark:bg-surface-dark p-8 rounded-2xl shadow-xl border border-red-100 dark:border-red-900/20 max-w-md w-full text-center">
          <span className="material-symbols-outlined text-red-500 text-5xl mb-4">error</span>
          <h2 className="text-xl font-bold text-stone-900 dark:text-white mb-2">Configuration Error</h2>
          <p className="text-stone-600 dark:text-stone-400 mb-6">{error}</p>
          <button
            onClick={() => window.location.reload()}
            className="w-full bg-primary hover:bg-primary-hover text-white font-bold py-2.5 rounded-lg transition-all"
          >
            Retry
          </button>
        </div>
