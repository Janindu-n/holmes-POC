...
function RegisterForm() {
  ...
  // Security Harden: Whitelist allowed roles to prevent privilege escalation via URL parameters.
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    // Security Harden: Minimum password length check
    ...
    try {
      ...
      // Security Harden: Mask detailed Firebase errors that might leak information (e.g., account enumeration).
      // We log the detailed error internally and show a user-friendly message.
