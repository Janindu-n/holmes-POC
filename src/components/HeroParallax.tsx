...
export default function HeroParallax() {
  ...
  useEffect(() => {
    const updateParallax = () => {
      ...
      // Directly update DOM properties to bypass React re-renders for high-frequency scroll events
      // This is a "Bolt" optimization for 60fps smoothness
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
          ...
          <div className="relative lg:h-auto h-[400px] w-full rounded-2xl overflow-hidden shadow-2xl">
            ...
            <div className="absolute bottom-6 left-6 right-6 z-20 text-white">
              <div className="items-center gap-2 mb-2 flex">
