 ...
 * 1. Uses requestAnimationFrame (RAF) for smooth 60fps parallax effects.
 * 2. Bypasses React's render cycle for scroll updates by directly manipulating DOM styles.
 * 3. Uses a 'ticking' flag to throttle updates to one per repaint cycle.
 * 4. Offloads high-frequency interactivity to this leaf Client Component,
 *    allowing the parent landing page to be a static Server Component.
 */
export default function HeroParallax() {
  ...
  useEffect(() => {
    ...
    const updateStyles = () => {
      if (contentRef.current) {
        ...
        // Optimization: Pre-calculate values to minimize style recalcs
    ...
    // Initial sync to handle page refresh/mounting at scroll position
    updateStyles();
  ...
  return (
    <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
      <div
        ref={contentRef}
        // Removing 'transition-all' to avoid interpolation lag with JS-driven styles
        // Adding 'will-change' to hint the browser to promote this to a compositor layer
