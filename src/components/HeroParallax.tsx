  ...
  useEffect(() => {
    ...
    const updateParallax = () => {
      ...
      if (contentRef.current) {
        // Optimization: Direct DOM manipulation bypasses React's state/re-render cycle
        // This is much more efficient for 60fps animations like parallax
    ...
    const handleScroll = () => {
      if (!ticking) {
        // Optimization: Use requestAnimationFrame to throttle updates to screen refresh rate
